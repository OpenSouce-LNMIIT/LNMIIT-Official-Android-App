 ...
 */
public class SlideImageFragment extends DialogFragment {
    ...
    static SlideImageFragment newInstance() {
        SlideImageFragment f = new SlideImageFragment();
        return f;
    }
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            Glide.with(getActivity()).load(image.getId())
                    .thumbnail(0.5f)
                    .crossFade()
